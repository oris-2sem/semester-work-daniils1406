...
<body>
<button class="btn btn-primary" onclick="getFlatPage()">getFlats</button>
...
<div>
    ...
    <br>
    <label>releaseDate
        <input id="releaseDateForCreate" name="releaseDateForCreate" type="date">
    </label>
    <br>
    <label>areaSquare
        <input id="areaSquareForCreate" name="areaSquareForCreate" type="number">
    </label>
    <br>
    <label>material
        <select id="materialForCreate" name="materialForCreate">
            <option value="BALK">BALK</option>
            <option value="BRICK">BRICK</option>
            <option value="AEROCRETE">AEROCRETE</option>
        </select>
    </label>
    <br>
    <label>levels
        <input id="levelsForCreate" name="levelsForCreate" type="number">
    </label>
    <label>currency
    ...
    <br>
    <button class="btn btn-info" onclick="createHouse(document.getElementById('residentialComplexForCreate').value,
...
document.getElementById('areaSquareForCreate').value,
document.getElementById('materialForCreate').value,
document.getElementById('levelsForCreate').value,
...
<table border="1" class="table table-striped">
    <#list realtyList as realty>
            ...
            <td>
                ...
                <#if imagesOfFlats[realty?index]?has_content>
                    <#list imagesOfFlats[realty?index] as image>
                        <img onclick="deleteViewHouse('${image}')" src="/file/downloadFile?id=${image}" width="15%">
                    </#list>
                </#if>
                <#--                </#list>-->
            </td>
        ...
        <tr>
            <td>
                <input id="id${realty.id}" name="id" value="${realty.id}" type="hidden">
                <label>residentialComplex
                    <input id="residentialComplex${realty.id}" name="residentialComplex"
                           value="${realty.residentialComplex.id}">
                </label>
                <input id="owner${realty.id}" name="owner" value="${realty.owner.id}" type="hidden">
                <label>square
                    <input id="square${realty.id}" name="square" value="${realty.square}">
                </label>
                <label>region
                ...
                <label>cost
                    <input id="cost${realty.id}" name="cost" value="${realty.cost}">
                </label>
                ...
                <label>areaSquare
                    <input id="areaSquare${realty.id}" name="areaSquare" value="${realty.areaSquare}">
                </label>
                <label>material
                    <select id="material${realty.id}" name="material">
                        <option value="BALK">BALK</option>
                        <option value="BRICK">BRICK</option>
                        <option value="AEROCRETE">AEROCRETE</option>
                    </select>
                ...
                <label>levels
                    <input id="levels${realty.id}" name="levels" value="${realty.levels}">
                </label>
                <label>currency
            ...
            <td>
                <button class="btn btn-outline-primary" onclick="changeHouse(
                        ...
                        document.getElementById('areaSquare${realty.id}').value,
                        document.getElementById('material${realty.id}').value,
                        document.getElementById('levels${realty.id}').value,
                        document.getElementById('owner${realty.id}').value,
                        document.getElementById('currency${realty.id}').value
                        )">ChangeRealty
                </button>
                <br>
                <button class="btn btn-outline-danger" onclick="deleteHouse(document.getElementById('id${realty.id}').value)">DeleteRealty</button>
                <br>
                <button class="btn btn-outline-secondary" onclick="hideHouse(document.getElementById('id${realty.id}').value)">hide</button>
                <br>
                <button class="btn btn-outline-info" onclick="showHouse(document.getElementById('id${realty.id}').value)">show</button>
            </td>
        </tr>
    </#list>
</table>
