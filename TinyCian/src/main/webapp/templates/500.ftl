    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-7 text-center">
                <img src="/static/img/HTTP-Error-500-Explained-And-How-To-Fix-500-Internal-Server-Error.png">
                <h2><b>500</b> Похоже произошла какая то поломка, приносим свои извинения</h2>
