...
<head>
    ...
    <title>Title</title>
    <script src="/static/js/agencys.js"></script>
...
<button class="btn btn-info" onclick="searchAgencys('VERIFIED',document.getElementById('column').value,
    document.getElementById('order').value)">Find
</button>
<table id="agencys" class="table table-striped">
